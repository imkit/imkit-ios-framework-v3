...
#ifndef IMKIT_SWIFT_H
#define IMKIT_SWIFT_H
...
@interface IMChatRoomViewController (SWIFT_EXTENSION(IMKit)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC5IMKit37IMDisableInputAccessoryViewController")
@interface IMDisableInputAccessoryViewController : UIInputViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@interface IMImageViewerViewController (SWIFT_EXTENSION(IMKit)) <UICollectionViewDataSourcePrefetching>
...
@interface IMImageViewerViewController (SWIFT_EXTENSION(IMKit)) <UICollectionViewDelegate>
- (void)scrollViewDidEndDecelerating:(UIScrollView * _Nonnull)scrollView;
@end
...
SWIFT_CLASS("_TtC5IMKit32IMMessageSearchingViewController")
@interface IMMessageSearchingViewController : UIObservableViewController
- (void)viewDidAppear:(BOOL)animated;
- (void)viewDidLayoutSubviews;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@interface IMMessageSearchingViewController (SWIFT_EXTENSION(IMKit)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface IMMessageSearchingViewController (SWIFT_EXTENSION(IMKit)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface IMMessageSearchingViewController (SWIFT_EXTENSION(IMKit)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC5IMKit24IMRoomGroupTableViewCell")
@interface IMRoomGroupTableViewCell : UITableViewCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface IMRoomsTableViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end
...
@interface IMRoomsTableViewController (SWIFT_EXTENSION(IMKit)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface IMRoomsTableViewController (SWIFT_EXTENSION(IMKit)) <UITableViewDataSource>
...
- (void)folderButtonDidPanWithPanGestureRecognizer:(UIPanGestureRecognizer * _Nonnull)panGestureRecognizer;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface IMRoomsViewController (SWIFT_EXTENSION(IMKit)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView willDisplayCell:(UITableViewCell * _Nonnull)cell forRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
SWIFT_CLASS("_TtC5IMKit25IMSearchResultsController")
@interface IMSearchResultsController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
